...
def train_full_eval(
    agent, train_env, eval_env, full_eval_env, train_replay, eval_replay, full_eval_replay, logger, args):
  ...
  driver_full_eval.on_step(full_eval_replay.add)
  ...
  while step < args.steps:
    ...
    if should_full_rollout(algo_updates):
      driver_train(full_policy_train, episodes=1)
  ...
  logger.write()
  print('Scaffolder training is done.')